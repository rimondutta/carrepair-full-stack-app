...
export const metadata: Metadata = {
  title: "Inside Sam's Automotive Repairs | Automotive Blog & Expert Guides",
  description: "Explore our collection of expert automotive repair guides, maintenance tips, and industry insights from the master technicians at Sam's Automotive Repairs.",
};
