  ...
  return (
    <>
      ...
      {variant === "sidebar" ? (
        ...
        <button
          onClick={() => setIsOpen(true)}
          className="bg-[#D70006] hover:bg-[#b00005] text-[#110E10] hover:text-white py-3.5 px-6 text-xs font-black uppercase tracking-[0.2em] transition-all duration-300 rounded-lg flex items-center justify-center gap-2 cursor-pointer shadow-lg shadow-[#D70006]/10 hover:shadow-[#b00005]/20"
        >
          <Calendar className="w-4 h-4" />
      ...
      {isOpen && mounted && createPortal(
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 overflow-y-auto">
          ...
          <div className="bg-[#1B1B1B] border border-[#2e2e2e] w-full max-w-lg rounded-2xl relative z-[10000] shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 flex flex-col my-auto max-h-[calc(100vh-2rem)]">
            ...
            {/* Top Indicator Strip */}
            <div className="h-1.5 w-full bg-[#D70006]"></div>

            {/* Header */}
            <div className="p-6 border-b border-[#2e2e2e] flex items-center justify-between">
              <div>
                <span className="text-[#D70006] text-[10px] font-black uppercase tracking-[0.2em] heading-font block mb-1">Book Appointment</span>
            ...
            <div className="p-6 overflow-y-auto flex-1">
              {status === 'success' ? (
                <div className="flex flex-col items-center text-center py-8 px-4 animate-in fade-in zoom-in duration-300">
                  ...
                  <button
                    onClick={() => setIsOpen(false)}
                    className="bg-[#D70006] hover:bg-[#b00005] text-[#110E10] hover:text-white px-8 py-3.5 font-bold uppercase tracking-widest text-xs transition-all duration-300 rounded-lg cursor-pointer"
                  >
                    Close Window
                  </button>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full bg-[#110E10] border ${touched.name && errors.name ? 'border-[#D70006]' : 'border-[#2e2e2e]'} focus:border-[#D70006] focus:ring-1 focus:ring-[#D70006]/30 pl-11 pr-5 py-3.5 text-white outline-none transition-all placeholder:text-[#333] font-medium tracking-wide rounded-lg text-sm`}
                      />
                    </div>
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full bg-[#110E10] border ${touched.email && errors.email ? 'border-[#D70006]' : 'border-[#2e2e2e]'} focus:border-[#D70006] focus:ring-1 focus:ring-[#D70006]/30 pl-11 pr-5 py-3.5 text-white outline-none transition-all placeholder:text-[#333] font-medium tracking-wide rounded-lg text-sm`}
                      />
                    </div>
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        type="tel"
                        placeholder="+1 (973) 868-4091"
                        value={formData.phone}
                        onChange={(e) => handleChange('phone', e.target.value)}
                        onBlur={() => handleBlur('phone')}
                        className={`w-full bg-[#110E10] border ${touched.phone && errors.phone ? 'border-[#D70006]' : 'border-[#2e2e2e]'} focus:border-[#D70006] focus:ring-1 focus:ring-[#D70006]/30 pl-11 pr-5 py-3.5 text-white outline-none transition-all placeholder:text-[#333] font-medium tracking-wide rounded-lg text-sm`}
                      />
                    </div>
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="w-full bg-[#110E10] border border-[#2e2e2e] focus:border-[#D70006] focus:ring-1 focus:ring-[#D70006]/30 px-5 py-3.5 text-white outline-none appearance-none font-medium tracking-wide rounded-lg text-sm"
                      >
                      ...
                      <ChevronDown className="absolute right-5 top-1/2 -translate-y-1/2 text-[#D70006] pointer-events-none" />
                    </div>
                  </div>
                    ...
                    <div className="flex flex-col gap-1.5">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`w-full bg-[#110E10] border ${touched.preferredDate && errors.preferredDate ? 'border-[#D70006]' : 'border-[#2e2e2e]'} focus:border-[#D70006] focus:ring-1 focus:ring-[#D70006]/30 pl-11 pr-3 py-3.5 text-white outline-none transition-all font-medium tracking-wide rounded-lg text-sm [color-scheme:dark]`}
                        />
                      </div>
                      {touched.preferredDate && errors.preferredDate && <span className="text-[#D70006] text-[10px] font-bold mt-1 uppercase tracking-wider">{errors.preferredDate}</span>}
                    </div>
                    <div className="flex flex-col gap-1.5">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`w-full bg-[#110E10] border ${touched.preferredTime && errors.preferredTime ? 'border-[#D70006]' : 'border-[#2e2e2e]'} focus:border-[#D70006] focus:ring-1 focus:ring-[#D70006]/30 pl-11 pr-3 py-3.5 text-white outline-none transition-all font-medium tracking-wide rounded-lg text-sm [color-scheme:dark]`}
                        />
                      </div>
                      {touched.preferredTime && errors.preferredTime && <span className="text-[#D70006] text-[10px] font-bold mt-1 uppercase tracking-wider">{errors.preferredTime}</span>}
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <textarea
                      ...
                      className={`w-full bg-[#110E10] border ${touched.message && errors.message ? 'border-[#D70006]' : 'border-[#2e2e2e]'} focus:border-[#D70006] focus:ring-1 focus:ring-[#D70006]/30 px-5 py-3.5 text-white outline-none transition-all placeholder:text-[#333] font-medium tracking-wide resize-none rounded-lg text-sm`}
                    />
                  ...
                  <button
                    ...
                    className="w-full bg-[#D70006] hover:bg-[#b00005] text-[#110E10] hover:text-white py-4 px-8 font-black uppercase tracking-[0.2em] flex items-center justify-center gap-3 transition-all duration-300 rounded-lg disabled:opacity-70 disabled:cursor-not-allowed cursor-pointer text-xs"
                  >
                    {status === 'submitting' ? (
                      <>
                  ...
                  {status === 'error' && (
                    <div className="p-3 bg-red-500/10 border border-red-500/20 text-[#D70006] text-[10px] font-bold uppercase tracking-widest text-center rounded-lg mt-2">
