  ...
  return (
    <article
      ...
      className={`group relative overflow-hidden bg-[#1B1B1B] 
        border border-[#2e2e2e] hover:border-[#79AD43]/50 
    ...
    >
      ...
      <div className="relative overflow-hidden aspect-[4/3] w-full">
        ...
        <div className="absolute bottom-4 right-4 
          w-14 h-14 bg-[#79AD43] flex items-center justify-center
          group-hover:bg-[#110E10] group-hover:border group-hover:border-[#79AD43]
        ...
        <span className="absolute top-4 left-0 
          bg-[#79AD43] text-white text-xs uppercase font-bold
      ...
      <div className="p-6 flex flex-col flex-1">
        <h3 className="text-white heading-font font-bold text-xl mb-3
          group-hover:text-[#79AD43] transition-colors duration-300">
          {service.title}
        </h3>
      ...
      {service.isActive && (
        <div className="absolute left-0 top-0 bottom-0 w-1 bg-[#79AD43] z-20" />
      )}
    </article>
  );
}
