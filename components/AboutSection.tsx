        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
          ...
          <div className="w-full lg:w-1/2 relative">
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 w-full h-1/2 bg-gradient-to-t from-[#110E10] to-transparent"></div>
            </div>
            ...
            {/* Dot pattern decor */}
            <div className="absolute -top-8 -left-8 w-32 h-32 bg-[radial-gradient(#79AD43_2px,transparent_2px)] [background-size:16px_16px] opacity-20 -z-10"></div>
          </div>
          ...
          <div className="w-full lg:w-1/2 mt-12 lg:mt-0">
            ...
            >
              Your Trusted MOT &amp; Car Repair Station in <span className="text-[var(--color-primary)] italic font-medium">Mountainside</span>
            </h2>
            ...
            >
              <p>
                J's Auto Repair Shop LLC is Mountainside&apos;s trusted destination for MOT testing, car servicing, and all aspects of vehicle repair. Located at 900 Mountain Ave, we use the latest diagnostic equipment and quality parts to keep your vehicle roadworthy and safe.
              </p>
              <p>
              ...
              <p>
                We believe every driver in Mountainside and the surrounding areas deserves a garage they can genuinely trust. That&apos;s why we keep you informed throughout the entire repair process and never carry out work without your approval. Your safety and satisfaction are always our top priority.
              </p>
            </div>
