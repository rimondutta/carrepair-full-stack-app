      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
          ...
          <div className="w-full lg:w-1/2 mt-12 lg:mt-0">
            ...
            >
              Your Trusted MOT &amp; Car Repair Station in <span className="text-[var(--color-primary)] italic font-medium">North Bergen</span>
            </h2>
            ...
            >
              <p>
                Sam's Automotive Repair is North Bergen&apos;s trusted destination for MOT testing, car servicing, and all aspects of vehicle repair. Located at 4410 Dell Ave, we use the latest diagnostic equipment and quality parts to keep your vehicle roadworthy and safe.
              </p>
              <p>
              ...
              <p>
                We believe every driver in North Bergen and the surrounding areas deserves a garage they can genuinely trust. That&apos;s why we keep you informed throughout the entire repair process and never carry out work without your approval. Your safety and satisfaction are always our top priority.
              </p>
            </div>
