...
export default function ContactInfoPanel() {
  ...
  const contactRows = [
    { icon: <Phone size={18} />, label: "Phone", value: "+1 (718) 481-9800", href: "tel:+1 (718) 481-9800" },
    { icon: <Mail size={18} />, label: "Email", value: "info@samsautomotiverepairs.com", href: "mailto:info@samsautomotiverepairs.com" },
    { icon: <MapPin size={18} />, label: "Address", value: "123-30 Merrick Blvd, Jamaica, NY 11434, United States", href: undefined },
  ];
    ...
    <div className="flex flex-col gap-16">
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          <div className="flex">
            <div className="w-1.5 h-3 bg-[#EAB308] transform -skew-x-12"></div>
            <div className="w-1.5 h-3 bg-[#EAB308] transform -skew-x-12 mx-0.5 opacity-60"></div>
            <div className="w-1.5 h-3 bg-[#EAB308] transform -skew-x-12 opacity-30"></div>
          </div>
          <span className="text-[#EAB308] text-xs font-bold uppercase tracking-widest heading-font flex items-center gap-4">
            CONTACT <div className="w-12 h-px bg-[#EAB308]"></div>
          </span>
        </div>
        ...
        <p className="text-[#999] text-base leading-relaxed mb-8">
          When you bring your vehicle to Sam's Automotive Repairs, you can rest easy knowing that your vehicle is in professional hands. We take every possible step to ensure your experience is pleasant and efficient.
        </p>
      ...
      >
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="w-12 h-px bg-[#EAB308]"></div>
        </div>
            ...
            return (
              <div 
                ...
                className={`flex justify-between items-center py-4 px-4 border-b border-[#2e2e2e] font-bold transition-all duration-300 ${
                  isToday ? "bg-[#EAB308]/5 border-l-4 border-l-[#EAB308]" : ""
                }`}
              >
                <span className={isToday ? "text-[#EAB308]" : "text-white"}>{row.day}</span>
                <span className={row.isClosed ? "text-[#EAB308]" : "text-[#999]"}>{row.time}</span>
              </div>
            );
          })}
        </div>
        ...
        <div className="flex items-center gap-4">
          {[
            ...
            <a 
              key={idx} 
              href={social.href} 
              className="w-12 h-12 border border-[#2e2e2e] flex items-center justify-center text-white transition-all duration-300 hover:bg-[#EAB308] hover:border-[#EAB308] hover:-translate-y-1 hover:shadow-lg hover:shadow-[#EAB308]/20"
            >
              {social.icon}
            </a>
          ))}
