    ...
    return (
      <div className="bg-[#1B1B1B] p-6 sm:p-10 md:p-16 border border-[#2e2e2e] relative overflow-hidden flex flex-col items-center text-center animate-in fade-in zoom-in duration-500">
        ...
        <p className="text-[#999] text-base mb-10 max-w-sm">
          Thank you for reaching out to Care Plus tire shoping. Our team will review your message and get back to you within 24 hours.
        </p>
        <button
          onClick={resetForm}
          className="border border-[#79AD43] text-[#79AD43] hover:bg-[#79AD43] hover:text-white px-8 py-3 font-bold uppercase tracking-widest text-xs transition-all duration-300"
        >
    ...
    <div className="bg-[#1B1B1B] p-6 sm:p-8 md:p-10 border border-[#2e2e2e] relative overflow-hidden">
      ...
      <div className="flex flex-col mb-10">
        <div className="flex items-center gap-3 mb-4">
          <div className="w-8 h-px bg-[#79AD43]"></div>
          <span className="text-[#79AD43] text-xs font-bold uppercase tracking-widest heading-font">
            GET IN TOUCH
          </span>
          <div className="w-8 h-px bg-[#79AD43]"></div>
        </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className={`w-full bg-[#110E10] border ${touched.name && errors.name ? 'border-[#79AD43]' : 'border-[#2e2e2e]'} focus:border-[#79AD43] focus:ring-1 focus:ring-[#79AD43]/30 px-5 py-4 text-white outline-none transition-all placeholder:text-[#333] font-medium tracking-wide`}
            />
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className={`w-full bg-[#110E10] border ${touched.email && errors.email ? 'border-[#79AD43]' : 'border-[#2e2e2e]'} focus:border-[#79AD43] focus:ring-1 focus:ring-[#79AD43]/30 px-5 py-4 text-white outline-none transition-all placeholder:text-[#333] font-medium tracking-wide`}
            />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className={`w-full bg-[#110E10] border ${touched.phone && errors.phone ? 'border-[#79AD43]' : 'border-[#2e2e2e]'} focus:border-[#79AD43] focus:ring-1 focus:ring-[#79AD43]/30 px-5 py-4 text-white outline-none transition-all placeholder:text-[#333] font-medium tracking-wide`}
            />
          ...
          <div className="flex flex-col gap-1.5 relative">
            ...
            <div className="relative group">
              <select
                ...
                className="w-full bg-[#110E10] border border-[#2e2e2e] focus:border-[#79AD43] focus:ring-1 focus:ring-[#79AD43]/30 px-5 py-4 text-white outline-none appearance-none font-medium tracking-wide"
              >
              ...
              <ChevronDown className="absolute right-5 top-1/2 -translate-y-1/2 text-[#79AD43] pointer-events-none group-focus-within:rotate-180 transition-transform duration-300" />
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col gap-1.5 relative">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full bg-[#110E10] border ${touched.preferredDate && errors.preferredDate ? 'border-[#79AD43]' : 'border-[#2e2e2e]'} focus:border-[#79AD43] focus:ring-1 focus:ring-[#79AD43]/30 pl-12 pr-5 py-4 text-white outline-none transition-all font-medium tracking-wide [color-scheme:dark]`}
              />
            </div>
          ...
          <div className="flex flex-col gap-1.5 relative">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full bg-[#110E10] border ${touched.preferredTime && errors.preferredTime ? 'border-[#79AD43]' : 'border-[#2e2e2e]'} focus:border-[#79AD43] focus:ring-1 focus:ring-[#79AD43]/30 pl-12 pr-5 py-4 text-white outline-none transition-all font-medium tracking-wide [color-scheme:dark]`}
              />
            </div>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <textarea
            ...
            className={`w-full bg-[#110E10] border ${touched.message && errors.message ? 'border-[#79AD43]' : 'border-[#2e2e2e]'} focus:border-[#79AD43] focus:ring-1 focus:ring-[#79AD43]/30 px-5 py-4 text-white outline-none transition-all placeholder:text-[#333] font-medium tracking-wide resize-none`}
          />
        ...
        <button
          ...
          className="bg-[#79AD43] hover:bg-[#b00005] text-white py-4 px-8 font-black uppercase tracking-[0.2em] flex items-center justify-center gap-3 transition-all duration-300 group disabled:opacity-70 disabled:cursor-not-allowed"
        >
          {status === 'submitting' ? (
            <>
        ...
        {status === 'error' && <div className="p-4 bg-red-500/10 border border-red-500/20 text-[#79AD43] text-xs font-bold uppercase tracking-widest text-center mt-2">Error sending message. Please try again.</div>}
