      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className={`w-full bg-[#110E10] border ${touched.name && errors.name ? 'border-[#D70006]' : 'border-[#2e2e2e]'} focus:border-[#D70006] focus:ring-1 focus:ring-[#D70006]/30 px-5 py-4 text-white outline-none transition-all placeholder:text-[#333] font-medium tracking-wide`}
            />
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className={`w-full bg-[#110E10] border ${touched.email && errors.email ? 'border-[#D70006]' : 'border-[#2e2e2e]'} focus:border-[#D70006] focus:ring-1 focus:ring-[#D70006]/30 px-5 py-4 text-white outline-none transition-all placeholder:text-[#333] font-medium tracking-wide`}
            />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className={`w-full bg-[#110E10] border ${touched.phone && errors.phone ? 'border-[#D70006]' : 'border-[#2e2e2e]'} focus:border-[#D70006] focus:ring-1 focus:ring-[#D70006]/30 px-5 py-4 text-white outline-none transition-all placeholder:text-[#333] font-medium tracking-wide`}
            />
          ...
          <div className="flex flex-col gap-1.5 relative">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full bg-[#110E10] border ${touched.preferredDate && errors.preferredDate ? 'border-[#D70006]' : 'border-[#2e2e2e]'} focus:border-[#D70006] focus:ring-1 focus:ring-[#D70006]/30 pl-12 pr-5 py-4 text-white outline-none transition-all font-medium tracking-wide [color-scheme:dark]`}
              />
            </div>
          ...
          <div className="flex flex-col gap-1.5 relative">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full bg-[#110E10] border ${touched.preferredTime && errors.preferredTime ? 'border-[#D70006]' : 'border-[#2e2e2e]'} focus:border-[#D70006] focus:ring-1 focus:ring-[#D70006]/30 pl-12 pr-5 py-4 text-white outline-none transition-all font-medium tracking-wide [color-scheme:dark]`}
              />
            </div>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <textarea
            ...
            className={`w-full bg-[#110E10] border ${touched.message && errors.message ? 'border-[#D70006]' : 'border-[#2e2e2e]'} focus:border-[#D70006] focus:ring-1 focus:ring-[#D70006]/30 px-5 py-4 text-white outline-none transition-all placeholder:text-[#333] font-medium tracking-wide resize-none`}
          />
