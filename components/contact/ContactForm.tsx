  ...
  if (status === 'success') {
    return (
      <div className="bg-[#1B1B1B] p-6 sm:p-10 md:p-16 border border-[#2e2e2e] relative overflow-hidden flex flex-col items-center text-center animate-in fade-in zoom-in duration-500">
        ...
        <button
          onClick={resetForm}
          className="border border-[#EAB308] text-[#EAB308] hover:bg-[#EAB308] hover:text-white px-8 py-3 font-bold uppercase tracking-widest text-xs transition-all duration-300"
        >
    ...
    <div className="bg-[#1B1B1B] p-6 sm:p-8 md:p-10 border border-[#2e2e2e] relative overflow-hidden">
      ...
      <div className="flex flex-col mb-10">
        <div className="flex items-center gap-3 mb-4">
          <div className="w-8 h-px bg-[#EAB308]"></div>
          <span className="text-[#EAB308] text-xs font-bold uppercase tracking-widest heading-font">
            GET IN TOUCH
          </span>
          <div className="w-8 h-px bg-[#EAB308]"></div>
        </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-1.5 relative">
            ...
            <div className="relative group">
              <select
                ...
                className="w-full bg-[#110E10] border border-[#2e2e2e] focus:border-[#EAB308] focus:ring-1 focus:ring-[#EAB308]/30 px-5 py-4 text-white outline-none appearance-none font-medium tracking-wide"
              >
        ...
        <button
          ...
          className="bg-[#EAB308] hover:bg-[#b00005] text-white py-4 px-8 font-black uppercase tracking-[0.2em] flex items-center justify-center gap-3 transition-all duration-300 group disabled:opacity-70 disabled:cursor-not-allowed"
        >
          {status === 'submitting' ? (
            <>
        ...
        {status === 'error' && <div className="p-4 bg-red-500/10 border border-red-500/20 text-[#EAB308] text-xs font-bold uppercase tracking-widest text-center mt-2">Error sending message. Please try again.</div>}
