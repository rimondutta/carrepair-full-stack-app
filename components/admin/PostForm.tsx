    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div
          className={`mb-6 p-4 rounded-lg text-sm font-medium ${
            message.type === 'success'
              ? 'bg-[#FFF0F0] text-[#EAB308] border border-[#EAB308]/20'
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="md:col-span-2">
          ...
          <input
            ...
            className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#EAB308]/20 focus:border-[#EAB308] outline-none transition-all text-gray-900"
        ...
        <div className="md:col-span-2">
          ...
          <input
            ...
            value={form.slug}
            onChange={handleChange}
            className="w-full px-4 py-2.5 border border-gray-300 rounded-lg bg-gray-50 focus:ring-2 focus:ring-[#EAB308]/20 focus:border-[#EAB308] outline-none transition-all text-gray-900"
        ...
        <div className="md:col-span-2">
          ...
          <textarea
            ...
            maxLength={200}
            rows={2}
            className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#EAB308]/20 focus:border-[#EAB308] outline-none transition-all text-gray-900 resize-none"
        ...
        <div className="md:col-span-2">
          ...
          <textarea
            ...
            onChange={handleChange}
            rows={12}
            className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#EAB308]/20 focus:border-[#EAB308] outline-none transition-all text-gray-900 resize-y"
        ...
        <div>
          ...
          <select
            ...
            value={form.status}
            onChange={handleChange}
            className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#EAB308]/20 focus:border-[#EAB308] outline-none transition-all text-gray-900 bg-white"
          >
      ...
      <div className="flex gap-3 mt-8 pt-6 border-t border-gray-200">
        ...
        <button
          ...
          disabled={loading}
          className="px-6 py-2.5 bg-[#EAB308] text-white rounded-lg font-medium hover:bg-[#A80003] transition-colors disabled:opacity-50"
        >
