...
const statusColors: Record<string, string> = {
  ...
  'in-progress': 'bg-[#D70006]/10 text-[#A80003] border-[#D70006]/20',
  completed: 'bg-[#D70006] text-white border-transparent',
  cancelled: 'bg-red-100 text-red-800 border-red-200',
  draft: 'bg-slate-50 text-slate-700 border-slate-100',
  published: 'bg-[#D70006] text-white border-transparent',
};
